...
function generateReviews(productIndex: number, count: number): SeedReview[] {
...
function reviewCountForProduct(productIndex: number): number {
...
const serviceCategories: SeedServiceCategory[] = [
  {
    slug: "bridal",
    name: "تجهيز العرايس",
    nameEn: "Bridal",
...
module.exports = { categories, products, services, serviceCategories, generateReviews, reviewCountForProduct };
